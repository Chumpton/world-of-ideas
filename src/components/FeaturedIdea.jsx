                ...
                <div className="featured-footer" style={{
                    ...
                    <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <span className="action-count" style={{ fontSize: '0.9rem', fontWeight: 'bold', color: 'var(--color-text-main)' }}>{featured.commentCount || 0}</span>
                        </div>
                        ...
                        >
                            ...
                            <span className="action-count" style={{ fontSize: '0.9rem', fontWeight: 'bold', color: 'var(--color-text-main)' }}>{featured.forks || 0}</span>
                        </div>
                        ...
                        >
                            ...
                            <span className="action-count" style={{ fontSize: '0.9rem', fontWeight: 'bold', color: 'var(--color-text-main)' }}>{featured.shares || 0}</span>
                        </div>
                    </div>
                </div>
            </div>
